// This particle system is created by Daniel Shiffman
// http://codingtra.in
// http://patreon.com/codingtrain

// Simple Particle System
// Edited Video: https://www.youtube.com/watch?v=m9bRVQ_-DXY&list=PLRqwX-V7Uu6YgpA3Oht-7B4NBQwFVe3pr&index=10

let particles;

function setup() {
  createCanvas(600, 400);
  particles = Array(100).fill(null).map(p => new Particle());
}
